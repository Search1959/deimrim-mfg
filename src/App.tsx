    ...
    <div className="flex h-screen bg-[#020617] overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-6 max-w-[1400px] mx-auto">
          ...
          {activeModule === "production"  && <ProductionView productionOrders={productionOrders} setProductionOrders={setProductionOrders} boms={boms} currentUser={currentUser} />}
          ...
          {activeModule === "sales"       && <SalesView salesOrders={salesOrders} setSalesOrders={setSalesOrders} dispatches={dispatches} setDispatches={setDispatches} customers={customers} setCustomers={setCustomers} boms={boms} finishedGoods={finishedGoods} setFinishedGoods={setFinishedGoods} setInvoices={setInvoices} currentUser={currentUser} />}
          {activeModule === "finance"      && <FinanceView invoices={invoices} setInvoices={setInvoices} purchaseOrders={purchaseOrders} setPurchaseOrders={setPurchaseOrders} suppliers={suppliers} setSuppliers={setSuppliers} rawMaterials={rawMaterials} setRawMaterials={setRawMaterials} customers={customers} salesOrders={salesOrders} currentUser={currentUser} />}
